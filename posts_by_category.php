...
$sql="SELECT * FROM blogposts where category='$keyword'";
...
$starting_limit_number=($page-1)*($results_per_page);
 ...
 $sql = "SELECT * FROM blogposts where category='$keyword' ORDER BY post_id DESC LIMIT ".$starting_limit_number.','.$results_per_page;
$result=mysqli_query($conn,$sql);
$post_array=array();
